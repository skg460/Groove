...
<div class="demo">
        ...
        <div class="item">
        <h3 style="color:white; text-align:left;">Top Artists</h3>
<ul  class="content-slider">
            ...
            <h3 style="color:white; text-align:left">Top Albums</h3>
          ...
          <h3 style="color:white; text-align:left;">Top Tracks</h3>
          <ul  class="content-slider">
