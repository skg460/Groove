...
<div class="container">
    <div class="column add-bottom">
        <div id="mainwrap">
            ...
            <div id="audiowrap">
                    <audio id="myAudio" controls="controls"><source src="Sai_Ve_Sai.mp3" type="audio/mpeg">Your browser does not support HTML5 Audio!</audio>
                <div id="tracks">
                    <a id="btnPrev">&larr;</a>
                    <a id="btnNext">&rarr;</a>
                </div>
