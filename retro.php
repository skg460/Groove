...
<div class="container">
    <div class="column add-bottom">
        <div id="mainwrap">
            ...
            <div id="audiowrap">
                    <audio preload id="myAudio" controls="controls"><source src="aaj mausam.mp3" type="audio/mpeg">Your browser does not support HTML5 Audio!</audio>
                <div id="tracks">
                    <a id="btnPrev">&larr;</a>
                    <a id="btnNext">&rarr;</a>
                </div>
